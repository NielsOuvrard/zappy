...
void Gui::menu_init(void)
{
    ...
    // _input_host_rect.setOrigin(_input_host_rect.getGlobalBounds().width / 2, _input_host_rect.getGlobalBounds().height / 2);
    ...
    // _input_port_rect.setOrigin(_input_port_rect.getGlobalBounds().width / 2, _input_port_rect.getGlobalBounds().height / 2);
...
//         if (event.text.unicode < 128 && event.text.unicode != 8 && _input_host.getString().getSize() < 15 && _input_host_selected && ((event.text.unicode >= 48 && event.text.unicode <= 57) || event.text.unicode == 46)) {
...
//         _input_host_rect.setPosition(_window->getSize().x / 2, _window->getSize().y / 2 - 100);
//         _input_host.setOrigin(_input_host.getGlobalBounds().width / 2, _input_host.getGlobalBounds().height / 2);
//         _input_host.setPosition(_window->getSize().x / 2, _window->getSize().y / 2 - 100);
//         _input_port_rect.setPosition(_window->getSize().x / 2, _window->getSize().y / 2 + 100);
//         _input_port.setOrigin(_input_port.getGlobalBounds().width / 2, _input_port.getGlobalBounds().height / 2);
//         _input_port.setPosition(_window->getSize().x / 2, _window->getSize().y / 2 + 100);
//     } else {
//         for (int i = 0; i < _buttons_sprites.size(); i++)
//             _buttons_sprites[i].setPosition(_window->getSize().x / 2, _window->getSize().y / 2 + i * 100);
//         _input_host.setPosition(40000, 40000);
//         _input_host_rect.setPosition(40000, 40000);
//         _input_port.setPosition(40000, 40000);
//         _input_port_rect.setPosition(40000, 40000);
...
//             //         text.setString(str);
//             //     }
//             //     else if (event.text.unicode == 8 && str.size() > 0) {
//             //         str.pop_back();
//             //         text.setString(str);
//             //     }
//             // }
